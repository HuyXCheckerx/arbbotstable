...
class RecoveryLogicTests(unittest.TestCase):
    def test_quote_includes_execution_and_slippage_reserves(self):
        ...
        self.assertTrue(recovery_quote_is_eligible(metrics, 0.50))

    def test_quote_below_target_is_not_eligible(self):
        metrics = recovery_quote_metrics(1_000_000_000, 1_000_600_000, 0.01, 1)
        self.assertFalse(recovery_quote_is_eligible(metrics, 0.50))
